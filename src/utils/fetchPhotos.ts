...
export default function fetchPhotos(setState: React.Dispatch<React.SetStateAction<IGallery[]>>, search: string): void {
    ...
    fetch(`https://api.pexels.com/v1/search?per_page=1000&query=${query}`, {
      headers: {
        Authorization:
          "563492ad6f91700001000001aa1757fa15d04b3b8ed2b8c1958a7869", //hide this key
      },
    })
      .then((resp) => {
        return resp.json();
